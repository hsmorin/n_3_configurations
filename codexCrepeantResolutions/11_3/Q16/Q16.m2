-- Explicit double-octic derivation for Q16 from 11_3.m2
-- Run with: M2 --script Q16.m2
R = QQ[x0,x1,x2,x3,x4]
Q16 = x1^2*x2^2*x3 + x1^2*x2^2*x4 - x1^2*x2^2 - 2*x1^2*x2*x3*x4 + 2*x1^2*x2*x3 - 2*x1^2*x2*x4^2 + 3*x1^2*x2*x4 - x1^2*x2 + x1^2*x3*x4^2 - x1^2*x3*x4 + x1^2*x4^3 - 2*x1^2*x4^2 + x1^2*x4 - 2*x1*x2^2*x3 - x1*x2^2*x4 + x1*x2^2 + x1*x2*x4^2 - x1*x2*x4 + x2^2*x3*x4
Q = Q16
F = homogenize(Q, x0)
S = QQ[x,y,z,w,u,v]
