-- Explicit double-octic derivation for Q15 from 11_3.m2
-- Run with: M2 --script Q15.m2
R = QQ[x0,x1,x2,x3,x4]
Q15 = -x1^2*x3*x4^2 + x1^2*x3*x4 + x1*x2*x3^2*x4 + x1*x2*x3*x4^2 - 2*x1*x2*x3*x4 + x1*x2*x3 - x1*x2*x4^2 + 2*x1*x2*x4 - x1*x2 - x1*x3^2 + x1*x3*x4^2 - 2*x1*x3*x4 + x1*x3 - x2*x3^3 - x2*x3^2*x4 + x2*x3^2 + x3^3 + x3^2*x4 - x3^2
Q = Q15
F = homogenize(Q, x0)
S = QQ[x,y,z,w,u,v]
