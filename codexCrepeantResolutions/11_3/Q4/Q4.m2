-- Explicit double-octic derivation for Q4 from 11_3.m2
-- Run with: M2 --script Q4.m2
R = QQ[x0,x1,x2,x3,x4]
Q4 = -x1^3*x4^2 + x1^3*x4 + x1^2*x2*x3*x4 - x1^2*x2*x4 - x1^2*x3*x4 + x1^2*x4^3 + x1^2*x4^2 - x1^2*x4 + x1*x2^2*x3 - x1*x2^2 - 2*x1*x2*x3*x4^2 + x1*x2*x4^2 + x1*x2*x4 + x1*x3*x4 - x1*x4^3 + x2^2*x3^2*x4 - x2^2*x3^2 - x2^2*x3*x4 + x2^2*x3 + x2*x3*x4^2 - x2*x3*x4
Q = Q4
F = homogenize(Q, x0)
S = QQ[x,y,z,w,u,v]
